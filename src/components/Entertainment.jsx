...
const Entertainment = () => {
  ...
  useEffect(()=>{
    fetch('https://newsapi.org/v2/top-headlines?country=ng&category=entertainment&apiKey=8a8819c9340c4e7f8dd1af5e2ef2a1bb')
      ...
      news.map((val, key)=>{
        return(
          <div className="col-lg-6 col-sm-12 mb-3 rounded" key={key}>
            <div className="card">
            <img src={val.urlToImage} class="card-img-top img-fluid" alt={val.source.name} />
